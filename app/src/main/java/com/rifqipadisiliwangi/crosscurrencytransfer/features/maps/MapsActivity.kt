package com.rifqipadisiliwangi.crosscurrencytransfer.features.maps
...
import com.rifqipadisiliwangi.crosscurrencytransfer.data.model.auth.register.MapData
    ...
    private inner class GetDirection(val url : String) : AsyncTask<Void, Void, List<List<LatLng>>>(){
        ...
        override fun onPostExecute(result: List<List<LatLng>>) {
            ...
            for (i in result.indices){
                ...
                lineoption.color(R.color.background_field)
